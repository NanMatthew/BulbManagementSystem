<template>
  <el-card class="box-card">
    <my-bread level1="库存管理" level2="产品列表"></my-bread>
    ...
    <el-row class="searchArea">
      <el-col :span="24">
        ...
        <el-button @click="$router.push({name:'goodsadd'})" type="success" plain>产品入库</el-button>
      </el-col>
    </el-row>
    <!-- 表格 -->
    <el-table height="450px" border stripe v-loading="loading" :data="list" style="width: 100%">
      ...
      <el-table-column prop="goods_price" label="产品价格" width="100"></el-table-column>
      <el-table-column prop="goods_weight" label="产品库存" width="80"></el-table-column>
